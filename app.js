...
function renderSignals(rows) {
  ...
  // UPDATE: HEADER TANPA SORT
  thead.innerHTML = "<tr>" + COLS.map(c => {
    // Pertahankan class untuk layout (col-star, col-symbol, col-reasons, col-locked)
    const classes = [c.className || "", (!isLoggedIn && c.locked) ? "col-locked" : ""].join(" ");
    // Return TH polos tanpa onclick
  ...
  // Default Sort tetap jalan (by Score) tapi user tidak bisa ubah
